...
"""
Utilizes Jason Brownlee's tutorial to build and train a GAN network to sythesize
abstract artwork. Model-saving currently disabled on line 310.
"""
...
def summarize_performance(status, g_model, latent_dim, n_samples=25):
    ...
    #Commented out due to JSON formatting errors
...
# load image data
path = ''
dataset = load_real_data(path)

n_batch = [16, 16, 16, 16, 16, 16, 1, 1]
n_epochs = [100, 100, 100, 100, 100, 100, 100, 100]
